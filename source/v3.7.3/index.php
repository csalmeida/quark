...
<html>
    <head>
      ...
      <meta name="description" content="Quark is a tool to creates themes for ProtonMail.">
      <meta name="keywords" content="ProtonMail,themes,creation,color,email,encrypted.">
    ...
    <body>
      <header>
        <div>
          <div class="logo">
            <h1>QUARK <sup>beta v1.1</sup></h1>
            <h2>A ProtonMail Theme Creator for v3.7.3.</h2>
          </div>
      ...
      <main>
        ...
        <div class="tutorial">
          <h2>How to apply theme on ProtonMail v3.7.3.</h2>
        ...
        <div class="about">
          <h2>About.</h2>
          <p>This is a tool can be used to quickly put together a theme for <a href="https://protonmail.com/" target="_blank">ProtonMail v3.7.3</a> without using any code.</p>
      ...
      <footer>
        <div>
          ...
          <a href="https://github.com/csalmeida/quark" target="_blank">Github.</a>
