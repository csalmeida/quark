...
function Preview() {
    ...
    console.log('Added ' + color + ' to preview.');
...
function previewUpdate(hex_attribute, color) {
  ...
  case 'base_color':
    console.log("Attribute is base color.");
    // Add color to array.
  ...
  case 'highlight_color':
    console.log("Attribute is highlight color.");
    // Add color to array.
  ...
  case 'navigation_color':
    console.log("Attribute is navigation color.");
    // Add color to array.
    colors.navigation_color = color;
    preview.applyColor(preview.navigation, color);
    break;
  case 'search_color':
    console.log("Attribute is search color.");
    // Add color to array.
    ...
    break;
  default:
    console.log("No colors set at the moment.");
    break;
  } // end of switch
...
$('.hex-box').change(function(){
  ...
  case 4:
    ...
    break;
  default:
    console.log("All colors where picked.");
    break;
  } // end of switch
});
